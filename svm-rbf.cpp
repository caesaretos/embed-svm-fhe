...
int main() {
    ...
    uint32_t n = 64; // SVM vectors dimensions (# of predictors)
    ...
    cc->EvalRotateKeyGen(keys.secretKey, {0, 1, 2, 4, 8, 16, 32, 64}); // powers of two upto n
    ...
    double lowerBound = -10.0, upperBound = 0.0;
    uint32_t polyDegree = 13; // 13, 27, 59, 119, 247, 495;
